...
namespace TestSYS
{
    static class Program
    {
        ...
        public static IServiceContainer ConfigureServices()
        {
            ...
            container.Register<IConfig>( _ => AppSettingsConfigurationProvider.GetData(), new PerContainerLifetime());
            ...
            container.Register<string, int, frmStudAmd>((factory, name, id) => new frmStudAmd(name, id));
