...
namespace TestSYS
{
    class Question
    {
        ...
        public void getQuestionDetails(int qId)
        {
            ...
            //this.setQAdd(String.Format("{0:dd-MMM-yy}", (dr.GetDateTime(8))));
            //this.setQAmd(String.Format("{0:dd-MMM-yy}", (dr.GetDateTime(9))));
            //ONLY RESET WHAT YOU NEED!!
            //this.setStatus(dr.GetString(6));
            //this.setRegDate(String.Format("{0:dd-MMM-yy}",dr.GetDateTime(?)));
            //this.setAmdDate(String.Format("{0:dd-MMM-yy}",dr.GetDateTime(?)));
        ...
        public int getQuestCount(String level)
        {
            ...
            String strSQL = "SELECT COUNT(*)  FROM Questions WHERE LevelCode = '" + level + "'";
            //SELECT COUNT(*) FROM Questions WHERE LevelCode = 'B' AND Status = 'a';
        ...
        public void displayQuestion(int[] ids)
        {
            int i;
            ...
            //Define SDQL query which retrieves MAX StudId in Students
            String strSQL = "SELECT *  FROM Questions WHERE QuestId = " + ids[0];
            ...
            this.setAns4(dr.GetString(6));
            this.setCorrectAns(Convert.ToInt32(dr.GetValue(7)));
            //See if its dangerous to leave other values to fate ????
