...
RegDate date, --(RegDate = System Date)
AmdDate date, --(AmdDate = System Date)
ExpDate date,  --(ExpDate = System Date + 13 weeks)
...
QAdd date, --(QAdd = System Date)
QAmd date, --(QAmd = System Date)
